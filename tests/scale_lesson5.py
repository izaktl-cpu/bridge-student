...
def _check(hands, idx, errors):
    ...
    if t_bid is None:
        errors.append(f'#{idx}: S אין 5+ קלפי מיגור')
    ...
    return s_cont, n_resp, final, sym
...
def run(n=3000):
    ...
    for i in range(n):
        try:
            ...
            s_cont, n_resp, final, sym = _check(hands, i, errors)
